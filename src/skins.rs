...
const ZORITE_DARK: Base = (0x16171A, 0x1B1D21, 0x16171A, 0xFFFFFF, 0x0A84FF, 0x9D7CD8, 0xD7BA7D);
const ZORITE_LIGHT: Base = (0xF2F2F4, 0xEAEAEE, 0xFFFFFF, 0x1D1D1F, 0x0A84FF, 0x7A4FB5, 0xB0852A);
    ...
    for entry in entries.flatten() {
        ...
        match serde_json::from_str::<SkinFile>(&text) {
            Ok(f) => {
                ...
                out.push(Skin { id: f.id, name: f.name, light, dark });
            }
